...
class LearningProvider extends ChangeNotifier {
  ...
  void _buildSteps() {
    ...
    _steps.add(
      LearningStep(
        ...
        teachingData: TeachingCardData(
          ...
          emoji: '📚',
          accentColor: AppColors.secondary, // ← التعديل هنا
        ),
        stepIndex: stepIdx++,
      ),
    );
    ...
    final cardEmojis = ['💡', '⭐', '✨'];
    final cardColors = [
      AppColors.secondary, // أزرق سماوي (بدل primaryBlue)
      AppColors.accent, // برتقالي دافئ (بدل primaryOrange)
      AppColors.accent2, // بنفسجي (بدل primaryPurple)
    ];
